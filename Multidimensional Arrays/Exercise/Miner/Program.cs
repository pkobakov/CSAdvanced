...
static void SwitchCommand(char[,] field, ref int startRow, ref int startCol, int allCoal, ref int collectedCoal, string currentCommand, ref bool isGameOver)
{
    int currentRow = -1;
    int currentCol = -1;
...
static void SwitchChar(char[,] field, ref int startRow, ref int startCol, int allCoal, ref int collectedCoal, int currentRow, int currentCol, char currentChar, ref bool isGameOver)
{
...
static bool IsValidCell(char[,] field, int row, int col)
{
