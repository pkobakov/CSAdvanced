...
PrintResult(n, matrix, aliveCells, sum);
 static void PrintResult(int n, int[,] matrix, int aliveCells, int sum)
{
...
static void CountTheAliveCells(int n, int[,] matrix, ref int aliveCells, ref int sum)
{
    for (int row = 0; row < n; row++)
    {
        for (int col = 0; col < n; col++)
...
static void ReadTheMatrix(int n, int[,] matrix)
{
    for (int row = 0; row < n; row++)
    {
